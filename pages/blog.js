    ...
    <div>
      ...
      <main>
        <section className="h-screen">
          <MainNavbar />
          <div className="bg-gray-50 dark:bg-slate-900 pt-16 pb-20 px-4 sm:px-6 lg:pt-24 lg:pb-28 lg:px-8">
            <div className="relative max-w-lg mx-auto lg:max-w-7xl">
              <div>
                <h2 className="text-3xl tracking-tight font-bold text-gray-900 dark:text-gray-100 sm:text-4xl">
                  Blog
                </h2>
                <div className="mt-3 sm:mt-4 lg:grid lg:grid-cols-2 lg:gap-5 lg:items-center">
                  <p className="text-xl text-gray-500 dark:text-gray-300">
                    Read our top stories, thoughts and ideas from the press.
                  </p>
              ...
              <div className="mt-6 pt-10 grid gap-16 lg:grid-cols-2 lg:gap-x-10 lg:gap-y-12">
                {posts.map((post) => (
                  <motion.div
                    ...
                    key={post.title}
                    className="p-5 rounded-md bg-white dark:bg-slate-800 shadow-xl"
                  >
                    ...
                    <div className="mt-3">
                      <a
                        href={post.href}
                        className="text-base font-semibold text-orange-600 hover:text-orange-500"
                      >
                        Read full story
                      </a>
                    </div>
