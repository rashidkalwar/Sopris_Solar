    ...
    <div className="text-right h-10 w-10 flex justify-center items-center z-[2]">
      <Menu as="div" className="relative inline-block text-left">
        ...
        >
          <Menu.Items
            className={`absolute ${
              isMobile ? 'left-0 origin-top-left' : 'right-0 origin-top-right'
            } mt-1 w-56 divide-y divide-gray-100 dark:divide-gray-600 rounded-md bg-white dark:bg-slate-800 shadow-lg ring-1 ring-black dark:ring-gray-600 ring-opacity-5 focus:outline-none`}
          >
